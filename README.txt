Project 2: Multithreaded Calculator (SMP - Simple Machine Program)
==============================
...
condition and prints that number to stdout, followed by a newline, and
...
multiplier, and degrouper threads, using synchronization to protect
...
Tip: See sentinel() for an example invocation of strcpy() th at shifts
